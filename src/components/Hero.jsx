...
const Hero = ({ scrollToDoc, lang = 'en' }) => {
  ...
  .map((part, i) =>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                        <Link className="inline-flex items-center justify-center rounded-xl font-medium transition-all focus:outline-none h-12 px-6 text-base bg-[#0033CC] hover:bg-[#002299] text-white shadow-md dark:bg-[#4F95FF] dark:hover:bg-[#3A80EA]" to={`/${lang}/procedures`}>{translate(uitext.heroSeeProcedures, lang)}</Link>
                        <button
                  ...
                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-6">
                    <h1 className="text-[#0033CC] mb-4 font-bold">
                  ...
                  <div className="bg-red-50 border-2 border-orange-400 rounded-lg p-6 mb-16">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="text-[#7e2a0c] mb-2 font-bold text-2xl">
                        ...
                        <section className="m-auto px-1 flex justify-center">
                          <button
                            ...
                            className="flex justify-center items-center w-full gap-2 bg-[#441306] text-orange-50 shadow-md font-semibold text-center py-3 px-6 rounded-xl hover:bg-[#542214] cursor-pointer"
                          >
