                          ...
                          <div>
                            ...
                            <section className="m-auto max-w-lg px-1">
                              <button
                                ...
                                className="flex justify-center items-center gap-2 bg-[#441306] dark:bg-[#6A2C1F] text-orange-50 shadow-md font-semibold text-center py-3 px-6 rounded-xl hover:bg-[#542214] dark:hover:bg-[#7F3B2B] cursor-pointer"
                              >
