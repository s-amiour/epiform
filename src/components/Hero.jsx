...
const Hero = () => {
    return (
        <>
            <div className="bg-blue-50 py-20 mb-4">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
                    {/* Welcome Header */}
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-6">
                        <h1 className="text-blue-600 mb-4 font-bold">Welcome to EPITA Kremlin-Bicêtre! 🇫🇷</h1>
                    ...
                    <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-6 mb-6">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="text-orange-900 mb-2 font-bold">Important Notice</h3>
                                ...
                                <a
                                    href="/contact"
                                    className="flex justify-center items-center gap-2 bg-orange-950 text-orange-50 shadow-md font-semibold text-center py-3 px-6 rounded-xl hover:bg-gray-700"
                                >
